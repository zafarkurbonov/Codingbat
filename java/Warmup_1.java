...
*/
   ...
   /* Given a non-empty string and an int n, return a new string where the char at index n has
    ...
    public String frontBack(String str) {
        ...
        return str.charAt(str.length()-1) + ss + str.charAt(0);
    }
    ...
    public String backAround(String str) {
        ...
        return str.length() >= 1 ? s + str + s : str;
    }
   ...
   /* Given a string, take the first 2 chars and return the string with the 2 chars added at both
    ...
    public String front22(String str) {
        ...
        String ca = str.substring(0, take);
        return ca + str + ca;
    }
...
/* Return true if the given string begins with "mix", except the 'm' can be anything,
   ...
   /* Given three int values, a b c, return the largest.
    ...
    public int close10(int a, int b) {
        return (Math.abs(a - 10) > Math.abs(b - 10)) ? b
                : (Math.abs(a - 10) < Math.abs(b - 10)) ? a : 0;
    }
  ...
  /*  Given two non-negative int values, return true if they have the same last digit, such as
   ...
   /* Given a string, return a new string where the last 3 chars are now in upper case. If the string
    ...
    public String endUp(String str) {
        ...
        int ss = str.length() - 3;
        String front = str.substring(0, ss);
        String back = str.substring(ss);
