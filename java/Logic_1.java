public class Logic_1 {
    ...
    public boolean cigarParty(int cigars, boolean isWeekend) {
        return ((isWeekend || cigars <= 60) && cigars >= 40) ? true : false;
    }
    ...
    public boolean squirrelPlay(int temp, boolean isSummer) {
        int SS = isSummer ? 100 : 90;
        return (temp >= 60 && temp <= SS) ? true : false;
    }
  ...
  /*  Given 2 ints, a and b, return their sum. However, sums in the range 10..19 inclusive, are forbidden,
   ...
   /* Return true if the given non-negative number is 1 or 2 more than a multiple of 20. See also:
    ...
    public boolean more20(int n) {
        return ((n % 20) == 2 || (n % 20) == 1) ? true : false;
    }
   ...
   /* Given 2 ints, a and b, return their sum. However, "teen" values in the range 13..19
    ...
    public int teenSum(int a, int b) {
        int c = a + b;
        return (a >= 13 && a <= 19 || b >= 13 && b <= 19) ? 19 : c;
    }
    ...
    public boolean answerCell(boolean isMorning, boolean isMom, boolean isAsleep) {
        return !isAsleep && (!isMorning || isMom) ? true : false;
    }
   ...
   /* Given a string str, if the string starts with "f" return "Fizz". If the string ends with "b" return
    "Buzz". If both the "f" and "b" conditions are true, return "FizzBuzz". In all other cases,
   ...
   /* Given an int n, return the string form of the number followed by "!". So the int 6 yields "6!". Except
    if the number is divisible by 3 use "Fizz" instead of the number, and if the number is divisible by 5 use
...
/*    Given three ints, a b c, return true if they are in strict increasing order, such as 2 5 11, or 5 6 7,
   ...
   /* Given three ints, a b c, return true if one of them is 10 or more less than one of the others.
    ...
    public boolean lessBy10(int a, int b, int c) {
        return (a >= b + 10 || b >= c + 10 || c >= a + 10 || c >= b + 10) ? true : false;
    }

   /* Return the sum of two 6-sided dice rolls, each in the range 1..6. However, if noDoubles is true,
     if the two dice show the same value, increment one die to the next value, wrapping around
   ...
   /* Given two int values, return whichever value is larger. However if the two values have the same remainder
    ...
    public int blueTicket(int a, int b, int c) {
        ...
        int bc = b + c;
        int ac = a + c;
        return (ab == 10 | bc == 10 | ac == 10) ? 10
                : (ab >= 10 + bc || ab >= 10 + ac) ? 5 : 0;
    }
    ...
    public boolean shareDigit(int a, int b) {
        ...
        int e = a % 10;
        int r = b % 10;
        return (c == d || e == r || c == r || d == e) ? true : false;
    }
